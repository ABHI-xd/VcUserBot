...
""",
                ...
                await m.reply_photo(
                    ...
                    caption=f"❤️<b>__Playing:__ </b>[{songname}]({url}) \n💡 chat id: {chat_id}\n👤**__Requested by:__** {m.from_user.mention} \n\n**𝚃𝙷𝙸𝚂 𝙸𝚂 𝙰 𝙼𝚄𝚂𝙸𝙲 𝙰𝙽𝙳 𝚅𝙸𝙳𝙴𝙾 𝙿𝙻𝙰𝚈𝙴𝚁 𝙱𝙾𝚃 𝙱𝚈 @TOXIC_CYBER**")
...
@Client.on_message(filters.command(["/vplay", ".vplay"], prefixes=f"{HNDLR}"))
